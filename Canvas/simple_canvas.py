...
class SimpleCanvas(BaseCanvas) :
  ...
  def draw_ATLAS_text( self, x, y, axes='main', **kwargs ) :
    super(SimpleCanvas, self).draw_ATLAS_text( x, y, axes=axes, **kwargs )

  def draw_legend( self, x, y, axes='main', **kwargs ) :
    super(SimpleCanvas, self).draw_legend( x, y, axes=axes, **kwargs )

  def draw_luminosity_text( self, x, y, luminosity_value, axes='main', **kwargs ) :
    super(SimpleCanvas, self).draw_luminosity_text( x, y, luminosity_value, axes=axes, **kwargs )

  def draw_text( self, x, y, extra_value, axes='main', **kwargs ) :
    super(SimpleCanvas, self).draw_text( x, y, extra_value, axes=axes, **kwargs )
